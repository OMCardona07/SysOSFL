<%@ Page Title="" Language="C#" MasterPageFile="~/MasterJefe.Master" AutoEventWireup="true" CodeBehind="Tareas_j.aspx.cs" Inherits="SysOSFL.GUID.Tareas_j" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <section class="form-registro">
        ...
        <asp:TextBox class="controles" ID="txtProyecto" runat="server"></asp:TextBox>
        <br />
        <br />
